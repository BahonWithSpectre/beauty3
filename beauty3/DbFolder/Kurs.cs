...
namespace beauty3.DbFolder
{
    public class Kurs
    {
        ...
        public string Pack3 { get; set; }
        public string Pack4 { get; set; }
        public string Pack5 { get; set; }

        public string Pack21 { get; set; }
        public string Pack22 { get; set; }
        public string Pack23 { get; set; }
